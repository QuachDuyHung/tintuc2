	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="trang-chu">Tin Tức</a>
			</div>
					...
					?>
						...
						<div class="row-item row">
							<h3>
								...
								$loaitin = explode(',',$mn->LoaiTin);
								foreach($loaitin as $loai){
									list($id, $ten, $tenkhongdau) = explode(':',$loai);		/* $tenkhongdau*/						
								?>
								<small><a href="<?=$tenkhongdau?>-<?=$id?>.html"><i><?php echo $ten ?></i></a>/</small>
								<?php
								}
								?>
							</h3>
							<div class="col-md-12 border-right">
								<div class="col-md-3">
									<a href="<?=$mn->TenKhongDau?>/<?=$mn->TieuDeTinKhongDau?>-<?=$mn->idTin?>.html">
								...
								<div class="col-md-9">
									<h3><?=$mn->TieuDeTin?></h3>
									<p><?=$mn->TomTatTin ?></p>
									<a class="btn btn-primary" href="<?=$mn->TenKhongDau?>/<?=$mn->TieuDeTinKhongDau?>-<?=$mn->idTin?>.html">Chi tiết <span class="glyphicon glyphicon-chevron-right"></span></a>
								</div>
